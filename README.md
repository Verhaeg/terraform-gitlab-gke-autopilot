...
| <a name="module_nat"></a> [nat](#module\_nat) | terraform-google-modules/cloud-nat/google | 2.1.0 |
...
| <a name="input_gitlab"></a> [gitlab](#input\_gitlab) | Set of configurations for GitLab | <pre>object({<br>    domain        = string<br>    cert_email    = string<br>    namespace     = string<br>    version       = string<br>    bucket_prefix = string<br>  })</pre> | n/a | yes |
